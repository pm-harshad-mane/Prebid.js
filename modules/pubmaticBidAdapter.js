...
export const spec = {
  ...
  */
  ...
  buildRequests: (validBidRequests, bidderRequest) => {
    ...
    if(bidderRequest.bidderCode === GROUPM_ALIAS.code){
        ...
        response.body.seatbid.forEach(seatbidder => {
          seatbidder.bid &&
            ...
            seatbidder.bid.forEach(bid => {
              ...
              if(bid.ext.marketplace && bid.ext.marketplace.toLowerCase() === GROUPM_ALIAS.code){
                newBid.bidderCode = GROUPM_ALIAS.code;
                newBid.bidder = GROUPM_ALIAS.code;
              }
